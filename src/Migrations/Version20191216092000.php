 ...
 */
final class Version20191216092000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_answer (id INT NOT NULL, question_id INT NOT NULL, text VARCHAR(255) NOT NULL, correct VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
